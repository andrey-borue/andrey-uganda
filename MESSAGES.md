...
> Шаблоны WhatsApp / email сообщений по бронированиям. Скопировать → отправить.
...
Could you please confirm the exact check-in location at Entebbe Airport? Specifically:
...
## 🏨 Bwindi Breeze Lodge — confirm meals + early checkout

**Кому:** WhatsApp **+256 776 482701**
**Бронь:** confirmation #6007745987

```
Hi, this is Andrey, confirmation #6007745987 for 8–9 May 2026 (1 night, 2 guests).

Our plan:
- Arrive ~12:30 on 8 May from Kisoro airstrip via Lake Mutanda. Could we drop bags early and have lunch before formal check-in at 14:00? Flexible window 12:30–14:00 works for us.
- Half Board, please (dinner 8 May + breakfast 9 May). We will NOT be returning for lunch on 9 May.
- 9 May we have gorilla trek at Rushaga, briefing 07:30. We need:
  • Packed breakfast at 05:30
  • Packed lunch for the trek (we will eat it on the road, not at the lodge)
  • Pre-checkout the evening of 8 May so we can leave at 06:30 with all our luggage
- Please confirm where to leave the room key at 06:30 (drop-box / night reception).
- We have our own 4WD rental — no transport needed. Just need a parking spot.
...
```
Hello, this is Andrey Boryu. Confirming our 4WD rental pickup:

- Date: 8 May 2026
- Location: Kisoro Airstrip (KSO), arriving on Aerolink flight from EBB
- ETA: 08:15 landing, ~08:30 ready at airstrip
- Drop-off: 16 May 2026, Entebbe (please confirm exact address — airport or town office)

Could you please confirm:
1. Name and phone number of the person meeting us at Kisoro
2. Vehicle make/model/year and odometer reading
3. Fuel type (petrol / diesel) and tank level at handover
4. Spare tyre, jack, recovery kit included?
5. Total deposit / payment terms
...
## ⛺ Kisoro Art Island (Kamere Tours) — confirm boat + canoe

**Кому:** Kamere Tours WhatsApp **+256 776 360 824** или **+256 394 857 250**
**Email:** info@kameretours.com

```
Hello, this is Andrey Boryu. Confirming our 1-night booking for 9 May 2026 at Kisoro Art Island (2 guests).

Could you please confirm:
1. Boat pickup time and location at Lake Mutanda shore — we expect to arrive at the shore around 14:30 on 9 May (driving from Rushaga after gorilla trek)
2. Is the boat transfer included in the rate?
3. Where can we safely park our 4WD overnight at the shore? (we drive ourselves)
4. Sunset canoe (~17:30) — confirmed and included? Local rower?
5. Breakfast 10 May at 07:00 + packed coffee/snack for the road
6. Morning boat back to shore — what time? We need to be in the car by 08:30 to drive to Ishasha.
7. Cancellation policy in case of Aerolink flight delay on 8 May
...
```
Hello, this is Andrey Boryu. Confirming our reservation for [DATE], [N nights], 2 guests.

Could you please confirm:
1. Booking reference / confirmation number on file
2. Check-in time and what we need to bring
3. Meal plan options (B&B / Half Board / Full Board) and prices
4. Parking for our 4WD rental (we drive ourselves)
5. Wifi availability in rooms / public areas
6. Cancellation policy

Thank you, looking forward to our stay!
```

---

## Когда что отправлять
